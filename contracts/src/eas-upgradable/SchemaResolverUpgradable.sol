...
import {AccessDenied, InvalidEAS, InvalidLength, uncheckedInc} from "@eas/contracts/Common.sol";
import {SemverUpgradable} from "./SemverUpgradable.sol";
import {ISchemaResolver} from "@eas/contracts/resolver/ISchemaResolver.sol";
import {Initializable} from "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

abstract contract SchemaResolverUpgradable is ISchemaResolver, SemverUpgradable {
    ...
    function __SchemaResolver_init(IEAS eas) internal onlyInitializing {
        SemverUpgradable.initialize(1, 3, 0);
